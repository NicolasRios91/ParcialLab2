...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    {
        returnAux = 0;
        for (i=0;i<ll_len(this);i++)//puedo simplificarlo
        {
            aux = ll_get(this,i);
            if(aux == pElement)
            {
...
int ll_containsAll(LinkedList* this,LinkedList* this2)//falta 1 para todos los elementos
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        //nodo = (Node*)malloc(sizeof(Node));//usar puntero a void en vez del nodo
        returnAux = 0;
            ...
            for (i=0;i<ll_len(this)-1;i++)
            {
                for (j=i+1;j<ll_len(this);j++)
                {
                    ...
                    if (aux == 1)
                    {
                        ...
                        set_2=ll_set(this,j,pElement_1); //tambien da ok seteando el pElement 1 en vez de pAux
                        //free(pAux);
                    }
                }
            }
...
LinkedList* ll_filter_parametro(LinkedList* this,int (*pFunc)(void*,char*),char* parametro)
{
    LinkedList* Copia =NULL;
